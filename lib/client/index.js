...
module.exports = function(ss, router) {
  ...
  // task: default ['pack-all','serve'] if not defined
  // depend on production or dev
  ...
  return {
    ...
    addTasks: function() {
      ...
      ss.orchestrator.add('build', this.buildTasks());
      ss.orchestrator.add('serve', this.serveTasks(), serveOndemand);
