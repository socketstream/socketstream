...
var server  = exports.server  = new EventEmitter2;
var message = exports.message = new EventEmitter2;
...
exports.load = {
    ...
    code: function(nameOrDir, cb) {
        ...
        var errorPrefix = 'SocketStream Error: The ss.load.code() command ';
