...
// Create an internal API object which is passed to sub-modules and can be
// used within your app; this is the 'ss' arg seen within the module definitions
var api = exports.api = {
  ...
  // Call ss.api.add('name_of_api', value_or_function) from your app to safely extend the 'ss' 
  // internal API object passed through to your /server code
...
// Note: only used by the ss-console module for now. This idea will be expanded upon in SocketStream 0.4
