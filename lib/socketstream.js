...
// in the future this will be managed by orchestrator module
var tasks = {};
...
exports.build = function() {
  build(arguments.length==0? ['pack-all'] : arguments)
};

exports.task = task;

task('pack-all', [], function() {
  // run through bundlers and pack each of them
});
