...
var app, connect, eventMiddleware, existslib, fileUtils, fs, gzip, loadStaticDirs, pathlib, router, settings, staticDirs, staticFiles, transformURL, useAfterStack;
...
module.exports = function(root) {
  return {
    ...
    load: function(staticPath, sessionStore, sessionOptions) {
      ...
      app.use(eventMiddleware).use(gzip.staticGzip(staticPath, settings["static"]));
      return app;
    },
