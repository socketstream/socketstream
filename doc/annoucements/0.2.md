...
Whereas version 0.1 did everything in a single thread, 0.2 allows the front end and back end to run as separate processes on multiple machines - opening up new opportunities to horizontally scale up according the your traffic at any given moment.
